...
def main() -> int:
    ...
    require_markers("scripts/smoke_dashboard_content.py", ["AppTest", "Story", "Taste Map", "Mix Shift", "Rediscovery", "Data Quality", "Local data quality signals", "dashboard content exposes the expected self-analytics sections"])
